...
public interface CreateJobCommandStep1 {
  ...
  /**
   * Set the type of the job (i.e. its category). This type is used when open a job subscription to
   * work on this jobs.
   *
   * @param type the type of this job (e.g. "my-todos")
  ...
  public interface CreateJobCommandStep2 extends FinalCommandStep<JobEvent> {
     ...
     *
     * @param headers the additional custom headers
     * @return the builder for this command. Call {@link #send()} to complete the command and send
     *     it to the broker.
     */
    ...
    /**
     * Set the initial retries of this job. The retries are decremented when the job is marked as
     * failed.
     *
     * @param retries the initial retries of this job. Must be greater than zero.
     * @return the builder for this command. Call {@link #send()} to complete the command and send
     *     it to the broker.
     */
