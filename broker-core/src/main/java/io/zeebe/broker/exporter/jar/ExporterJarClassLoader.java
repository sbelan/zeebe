 ...
 *
 * <p>To completely isolate our own code simply change the second constructor argument to be the
 * bootstrap class loader and not the system or application class loader. Additionally, for all
 * exposed classes, you'd need to hide or limit access to their class loader (i.e. the system class
 * loader).
 */
