...
public class ExporterRepository {
  ...
  public ExporterDescriptor load(
    ...
    if (descriptor == null) {
      ...
      if (!validate(descriptor)) {
        throw new ExporterLoadException(id, "failed validation");
      }
  ...
  private boolean validate(final ExporterDescriptor descriptor) throws ExporterLoadException {
    ...
    try {
      ...
      isValid = instance.validate(context);
