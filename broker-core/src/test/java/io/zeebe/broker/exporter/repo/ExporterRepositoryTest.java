...
public class ExporterRepositoryTest {
  ...
  @Test
  public void shouldFailToLoadIfExporterExceptionallyInvalid() {
    // given
    final String id = "exporter";
    final Class<? extends Exporter> exporterClass = ExceptionallyInvalidExporter.class;
  ...
  static class ExceptionallyInvalidExporter implements Exporter {
    @Override
